...
class Firebase {
  ...
  createStorageRef = (uid, date, workoutId, setId) => this.storage.ref(`users/${uid}/workoutVideos/${date}/${workoutId}/${setId}/video`);

  storageRef = () => this.storage.ref();

  saveVideo = (uid) => this.storage.ref(`users/${uid}/workoutVideos`);
