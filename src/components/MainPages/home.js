    ...
    return (
      <div>
        ...
        <CueVideos
          ...
          aboutCue1={"When performing a squat, make sure that your shoulders stay aligned and that you're not leaning too much to one side. This is especially important if you're squatting with a barbell, as it ensures that your weights don't fall off."}
          aboutCue2={"Failure to keep shoulders aligned while squatting can result in serious injury if squatting with a barbell. Leaning even a tiny bit towards one side can cause you to lose balance and lose control of both yourself and the barbell. To avoid this, make sure that you have the same amount of weight on each side of the bar, and that you're squatting evenly."}
        />
        <CueVideos
          cuenumber="3"
          cueName={"Feet Width"}
